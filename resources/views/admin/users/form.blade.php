                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <div class="form-group mb-4">
                                <label class="mb-1">Instansi (Harap Kosongkan jika tidak di instansi)</label>
                                <select class="form-select form-control form-control-sm" id="instansi" name="instansi_id" style="width: 100%">
                                    @if (isset($data['instansi_id']) && !empty($data['instansi_id']))
...
@section('importfootAppend')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#instansi').select2({
                placeholder: 'Harap pilih instansi',
                allowClear: true,
                width: 'resolve',
                ajax: {
                    url: "admin/instansi/select2",
                    dataType: "json",
                    cache: true,
                    data: function(e) {
                        return {
