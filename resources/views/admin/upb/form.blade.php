...
@section('importfootAppend')
    <script>
        $(document).ready(function() {
            // Saat sub unit dipilih, isi bidang & unit sesuai relasi sub unit
            $('#sub_unit_id').on('change', function() {
                var selected = $(this).find('option:selected');
                var bidangId = selected.data('bidang');
            ...
            // Saat unit dipilih, bidang otomatis terisi sesuai relasi unit
            ...
            // Saat bidang diganti manual, reset unit & sub unit
