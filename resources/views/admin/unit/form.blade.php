...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="card">
            ...
            <form action="admin/unit{{ isset($data['nama_unit']) ? '/' . request()->segment(3) : null }}" autocomplete="off" method="POST" class="ajax">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 mb-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-sm" name="kode_unit" placeholder="Silahkan Isi Disini" value="{{ isset($data['kode_unit']) ? $data['kode_unit'] : null }}" required>
                            </div>
                        </div>
                        <div class="col-sm-6 mb-2">
                            <div class="form-group">
                                <label for="nama_unit" class="form-label">Nama Unit</label>
                                <input type="text" class="form-control form-control-sm" name="nama_unit" placeholder="Silahkan Isi Disini" value="{{ isset($data['nama_unit']) ? $data['nama_unit'] : null }}" required>
                            </div>
                        </div>
                        <div class="col-sm-3 mb-2">
                            <div class="form-group">
...
<script>
        $(document).ready(function() {
            ...
            // Saat halaman load, jika sub kabupaten_kota sudah terisi, isi provinsi & kabupaten_kota sesuai relasi sub kabupaten_kota
            if($('#provinsi_id').val()){
                $('#provinsi_id').trigger('change');
            } else if($('#kabupaten_kota_id').val()){
