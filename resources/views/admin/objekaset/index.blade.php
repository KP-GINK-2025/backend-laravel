            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6 col-12 d-flex justify-content-center justify-content-md-start align-items-center mb-3 mb-md-0">
                        <h3 class="card-title">Data Objek Aset</h3>
                    </div>
                    <div class="col-md-6 col-12 d-flex justify-content-center justify-content-md-end mb-md-0 mb-2">
                        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <a class="btn btn-outline-primary" href="admin/objekaset/create"><i class="fas fa-plus"></i> Add Objek Aset</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formDelete" action="admin/objekaset/">
        ...
        $(document).ready(function() {
            ...
            let dataTable = $('#Datatable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'kode_objek_aset',
                        name: 'kode_objek_aset'
                    },
                    {
                        data: 'nama_objek_aset',
                        name: 'nama_objek_aset'
                    },
                    {
                        data: 'kode',
                        name: 'kode',
            ...
            modalDelete.addEventListener('show.bs.modal', function(event) {
                ...
                element.setAttribute('action', 'admin/objekaset/' + id);
            });

            modalDelete.addEventListener('hidden.bs.modal', function(event) {
                var element = document.querySelector('#formDelete');
                element.setAttribute('action', 'admin/objekaset');
            });
